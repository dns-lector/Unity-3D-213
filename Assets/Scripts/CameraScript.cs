...
public class CameraScript : MonoBehaviour
{
    ...
    {
        if(fpv)
        {   // Завдання: обмежити максимальне віддалення камери від персонажа.
...
/* Д.З. Управління камерою
 * реалізувати залежність обмеження вертикального кута огляду камери
 * у залежності від віддаленості від поля:
 * - чим далі камера від поля, тим менша межа підйому кута камери
 *     (щоб поле ни виходило з поля зору)
 * - чим ближча, тим більша ця межа
 */
